...
PYNM_REST_APP_ERROR_UNKNOWN = 0
PYNM_REST_APP_ERROR_NOT_ALLOWED = 1
PYNM_REST_APP_ERROR_NOT_REALIZED = 2
PYNM_REST_APP_ERROR_PARAM_INVALID_STRUCTURE = 3
PYNM_REST_APP_ERROR_PARAM_INVALID_VALUE = 4
PYNM_REST_APP_ERROR_PARAM_INVALID_TYPE = 5
PYNM_REST_APP_ERROR_AUTH_NOT_PROVIDED = 6
PYNM_REST_APP_ERROR_AUTH_INVALID = 7
PYNM_REST_APP_ERROR_AUTH_EXPIRED = 8
PYNM_REST_APP_ERROR_AUTH_FORBIDDEN = 9
PYNM_REST_APP_ERROR_NOT_EXIST = 10
PYNM_REST_APP_ERROR_EXTERNAL_SERVICE = 11
PYNM_REST_APP_ERROR_DATABASE = 12
...
class ServerError(ApiError):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.app_error_code = PYNM_REST_APP_ERROR_UNKNOWN
...
class NotRealizedMethodError(ServerError):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.app_error_code = PYNM_REST_APP_ERROR_NOT_REALIZED
...
class ExternalServiceError(ServerError):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.status_code = 500
        self.app_error_code = PYNM_REST_APP_ERROR_EXTERNAL_SERVICE
...
class NotAllowedMethodError(ClientError):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.app_error_code = PYNM_REST_APP_ERROR_NOT_ALLOWED
...
class InvalidBodyStructureError(ClientError):
    ...
    def __init__(self, *args, **kwargs):
        super(ClientError, self).__init__(*args, **kwargs)
        self.status_code = 400
        self.app_error_code = PYNM_REST_APP_ERROR_PARAM_INVALID_STRUCTURE
...
class InvalidParamValueError(ClientError):
    ...
    def __init__(self, *args, **kwargs):
        super(ClientError, self).__init__(*args, **kwargs)
        self.status_code = 400
        self.app_error_code = PYNM_REST_APP_ERROR_PARAM_INVALID_VALUE
...
class InvalidParamTypeError(ClientError):
    ...
    def __init__(self, *args, **kwargs):
        super(ClientError, self).__init__(*args, **kwargs)
        self.status_code = 400
        self.app_error_code = PYNM_REST_APP_ERROR_PARAM_INVALID_TYPE
...
class NotExistError(ClientError):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.app_error_code = PYNM_REST_APP_ERROR_NOT_EXIST
...
class AuthCredentialsIsNotProvided(ClientError):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.app_error_code = PYNM_REST_APP_ERROR_AUTH_NOT_PROVIDED
...
class AuthCredentialsInvalid(ClientError):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.status_code = 401
        self.app_error_code = PYNM_REST_APP_ERROR_AUTH_INVALID
...
class AuthCredentialsExpired(ClientError):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.status_code = 401
        self.app_error_code = PYNM_REST_APP_ERROR_AUTH_EXPIRED
...
class AuthForbidden(ClientError):
    ...
    def __init__(self, *args,**kwargs):
        ...
        self.app_error_code = PYNM_REST_APP_ERROR_AUTH_FORBIDDEN
