...
LAMB_LOG_FORMAT_CELERY_TASK_SIMPLE = "[%(asctime)s: %(levelname)9s/%(processName)s] Task %(task_name)s[%(task_id)s] %(message)s"
LAMB_LOG_FORMAT_CELERY_MAIN_PREFIXNO = "[%(asctime)s: %(levelname)9s/%(processName)s, %(prefixno)04d, %(asctime)s-%(prefixno)04d] %(message)s"
