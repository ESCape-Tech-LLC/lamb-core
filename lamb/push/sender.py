...
#     PLATFORM_ANDROID
# )
# from pynm.db.session import lamb_db_session_maker
#
...
#             use_sandbox=True,
#             cert_file=settings.LAMB_APNS_CERT_SANDBOX,
#             key_file=settings.LAMB_APNS_CERT_SANDBOX,
#             enhanced=True
#         )
...
#             use_sandbox=False,
#             cert_file=settings.LAMB_APNS_CERT_PRODUCTION,
#             key_file=settings.LAMB_APNS_CERT_PRODUCTION,
#             enhanced=True
#         )
...
#
#         # Configure GCM
#         self.gcm = GCM(settings.LAMB_GOOGLE_PLAY_GCM_API_KEY)
#
