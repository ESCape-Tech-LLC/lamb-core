...
from marble.rest.exceptions import ServerError
...
try:
    ...
    _engine = create_engine(_CONNECTION_STRING, echo=getattr(settings, 'MARBLE_SQLALCHEMY_ECHO', False), pool_recycle=3600)
